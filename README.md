...
This will build the site and push it to the `gh-pages` branch, which GitHub Pages will use to serve the site.
...
- `src/` - Source code
  ...
  - `index.css` - Global styles and Panda CSS configuration
